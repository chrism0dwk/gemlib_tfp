...
from gemlib_tfp.mcmc.event_time_proposal import (
    TransitionTopology,
...
class UncalibratedEventTimesUpdate(tfp.mcmc.TransitionKernel):
    ...
    def __init__(
        ...
        self._dtype = tf.convert_to_tensor(initial_state).dtype
    ...
    def bootstrap_results(self, init_state):
        with tf.name_scope("uncalibrated_event_times_rw/bootstrap_results"):
            ...
            return EventTimesKernelResults(
                ...
                extra=tf.zeros(init_state.shape[-3], dtype=self._dtype,
            )
