"""Occult (fully censored) event time kernel"""

import tensorflow as tf
import tensorflow_probability as tfp

from gemlib_tfp.distributions import UniformInteger
from gemlib_tfp.distributions import Categorical2
    ...
    def t():
        ...
        with tf.name_scope("t"):
            return UniformInteger(
                low=[t_range[0]], high=[t_range[1]], dtype=dtype
            )
...
def DelOccultProposal(
    ...
    def x_star(m, t):
        ...
        with tf.name_scope("x_star"):
            ...
            return UniformInteger(
                low=0, high=bound + 1, dtype=dtype, name="x_star"
            )
